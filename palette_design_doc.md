...
**Palette** is a social art discovery app that helps art lovers track paintings they've seen,
discover new works by artists they love, and share their artistic taste with friends. Like Spotify
Wrapped meets Instagram, but for museum-goers.

---

## 📖 Origin Story

The "Gerard Von Honthorst moment" - recognizing an artist's work in Utrecht after seeing their
painting in Paris, but not knowing:
...
**My Opinion**: I LOVE "Palette" - it's unique, the metaphor is perfect (arranging your favorite
paintings like colors on a palette), and the feature of showcasing your top 8 in a grid literally IS
a palette. Keep it! 🎨
...
**Palette** is a unique and viable concept that solves a real problem for art lovers. The MVP is
achievable in 2-3 weeks, and the roadmap provides clear direction for growth.
